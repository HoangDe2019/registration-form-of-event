 ...
 */
class PrescriptionListTransformer extends TransformerAbstract
{
    /**
    ...
    public function transform(Prescription $prescription)
    {
        try {
            ...
            return [
                ...
                'user_doctor_id'=>$prescription->medicalhistory->user->id,
                'user_avatar'=>$avatar,
                'full_name_doctor' =>$prescription->medicalhistory->user->profile->full_name,
                'department_doctor' =>$prescription->medicalhistory->user->department->name,
