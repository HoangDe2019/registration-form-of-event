...
class WeekOfScheudeOfUsersDoctorlTransformer extends TransformerAbstract
{
    public function transform(Week $week)
    {
        try {
            //get schedule of week for every user
            ...
            if (!empty($schudel)) {
                ...
                $schudel = array_map(function ($schudel) {
                    ...
                    $Booking_Time = BookBefore::model()->where(['medical_schedule_id' => $schudel['id']])->get()->toArray();
                    return [
