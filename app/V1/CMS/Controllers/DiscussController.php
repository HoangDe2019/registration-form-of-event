...
use App\V1\CMS\Models\DiscussModel;
use App\V1\CMS\Models\NotifyModel;
use App\V1\CMS\Transformers\Discuss\DiscussTransformer;
use App\V1\CMS\Validators\DiscussCreateValidator;
use App\V1\CMS\Validators\DiscussUpdateValidator;
...
class DiscussController extends BaseController
{
    ...
    public function detailDiscuss($id, DiscussTransformer $discussTransformer)
    {
        try {
    ...
    public function delete($id)
    {
        ...
        return ['status' => Message::get("discuss.delete-success", $result->id)];
    }
}
