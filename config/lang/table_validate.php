...
$table_validate = [
    ...
    "users.create-account" => [
        "EN" => "created  account successful",
        "VI" => "Đăng ký tài khoản thành công",
    ],
    "users.create-account-faild" => [
        "EN" => "Created  account are failed",
        "VI" => "Đăng ký tài khoản that bai",
    ],
    ...
    "users.mail_send_update_profile_patient" => [
        "EN" => "your phone number is validated successfully",
        "VI" => "Số điện thoại của bạn đã được xác thực thành công! ",
    ],
