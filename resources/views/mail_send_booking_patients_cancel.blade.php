                                                ...
                                                <table width="100%" align="center" border="0" cellspacing="0" cellpadding="0">
                                                    ...
                                                    <tr>
                                                        <td align="center" style="text-align:justify;font-family:Arial,Helvetica,sans-serif;font-size:14px;font-style:italic;color:#0b499c;padding:10px 0px 0px 0px">
                                                            Lịch khám của bệnh nhân được hủy thành công<br>
                                                            Bệnh nhân có thể chọn khung giờ khác!.<br>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td align="center" style="text-align:justify;font-family:Arial,Helvetica,sans-serif;font-size:14px;font-weight:700;font-style:italic;color:#0b499c;padding:10px 0px 20px 0px">
                                                            Chú ý: <span style="color:#000000;font-weight:400"><i style="color:red">Bệnh nhân đã hủy lịch thành công và không còn trong hệ thống đăng lịch khám bệnh ở trên<br>Bệnh nhân cố thể xem chọn lịch khám bệnh của bác sĩ khác hoặc chờ đặt lại lịch của bác sĩ trên vào khung giờ tiếp theo</i></span>
                                                        </td><td>
                                                        </td>
                                                    </tr>
                                                    <tr>
