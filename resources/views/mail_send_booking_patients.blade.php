                                                ...
                                                <table width="100%" align="center" border="0" cellspacing="0" cellpadding="0">
                                                    <tbody><tr>
                                                        <td align="center" style="text-align:justify;font-family:Arial,Helvetica,sans-serif;font-size:14px;font-weight:700;font-style:italic;color:#0b499c;padding:30px 0px 0px 0px">
                                                            Kính gửi Quý bệnh nhân: <span style="color:#000000;font-weight:400"> {{$name}} </span>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="center" style="text-align:justify;font-family:Arial,Helvetica,sans-serif;font-size:14px;font-style:italic;color:#0b499c;padding:10px 0px 0px 0px">
                                                            Chào mừng bạn đến với hệ thống đặt lịch trực tuyên của chúng tôi</br><i>Bạn vừa thực hiện thành công quá trình đặt lịch khám bệnh nội dung như sau:</i>:
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="center" style="text-align:justify;font-family:Arial,Helvetica,sans-serif;font-size:14px;font-weight:700;font-style:italic;color:#0b499c;padding:10px 0px 0px 0px">
                                                            Tên bệnh nhân đặt lịch: <span style="color:#000000;font-weight:400"> {{$name}}, </span>
                                                        </td><td>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="center" style="text-align:justify;font-family:Arial,Helvetica,sans-serif;font-size:14px;font-weight:700;font-style:italic;color:#0b499c;padding:10px 0px 0px 0px">
                                                            Số điện thoại: <span style="color:#000000;font-weight:400"> {{$phone}} </span>
                                                        </td><td>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="center" style="text-align:justify;font-family:Arial,Helvetica,sans-serif;font-size:14px;font-weight:700;font-style:italic;color:#0b499c;padding:10px 0px 0px 0px">
                                                            Địa chỉ: <span style="color:#000000;font-weight:400"> {{$address}} </span>
                                                        </td><td>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="center" style="text-align:justify;font-family:Arial,Helvetica,sans-serif;font-size:14px;font-weight:700;font-style:italic;color:#0b499c;padding:10px 0px 0px 0px">
                                                            Lịch hẹn khám bệnh với bác sĩ: <span style="color:#000000;font-weight:400"> {{$doctor_name}} </span>
                                                        </td><td>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="center" style="text-align:justify;font-family:Arial,Helvetica,sans-serif;font-size:14px;font-weight:700;font-style:italic;color:#0b499c;padding:10px 0px 0px 0px">
                                                            Ngày làm việc: <span style="color:#000000;font-weight:400"> {{$date_work}} </span>
                                                        </td><td>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="center" style="text-align:justify;font-family:Arial,Helvetica,sans-serif;font-size:14px;font-weight:700;font-style:italic;color:#0b499c;padding:10px 0px 0px 0px">
                                                            Buổi làm việc: <span style="color:#000000;font-weight:400"> {{$session}} </span>
                                                        </td><td>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="center" style="text-align:justify;font-family:Arial,Helvetica,sans-serif;font-size:14px;font-weight:700;font-style:italic;color:#0b499c;padding:10px 0px 0px 0px">
                                                            Thời gian khám bệnh: <span style="color:#000000;font-weight:400"> {{$book_time}} </span>
                                                        </td><td>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="center" style="text-align:justify;font-family:Arial,Helvetica,sans-serif;font-size:14px;font-weight:700;font-style:italic;color:#0b499c;padding:10px 0px 20px 0px">
                                                            Chú ý: <span style="color:#000000;font-weight:400"><i style="color:#000000">Đây là thông tin mà bệnh nhân vừa đăng ký khám bệnh<br> Kính mong bệnh nhân chờ xác nhận thông tin đăng ký khám bệnh<br>Vui lòng bệnh nhớ kiểm tra thông tin xác nhận đăng ký khám bệnh trên hệ thông hoặc tin nhắn thông qua gmail.<br>Chân thành cảm ơn quý bệnh nhân đã quan tâm tin đến bệnh viên của chúng tôi.</i></span>
                                                        </td><td>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="center" style="text-align:justify;font-family:Arial,Helvetica,sans-serif;font-size:14px;font-weight:700;font-style:italic;color:#0b499c;padding:10px 0px 20px 0px">
                                                            Chi nhánh/quản  lý: <span style="color:#000000;font-weight:400">BỆNH VIỆN TRƯỜNG ĐẠI HỌC CẦN THƠ</span>
                                                        </td><td>
                                                        </td>
                                                    </tr>
