...
$api->get('/medical-schedules/week/users', [
    'action' => 'VIEW-MEDICAL_SCHEDULES',
    'uses' => 'MedicalScheduleController@searchWeekofUsers',
]);

$api->get('/medical-schedules/week/users/{id:[0-9]+}', [
    'action' => 'VIEW-MEDICAL_SCHEDULES',
    'uses' => 'MedicalScheduleController@searchWeekofUsersId',
]);
